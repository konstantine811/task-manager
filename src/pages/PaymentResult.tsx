...
export default function PaymentResult() {
  ...
  const content = {
    success: {
      icon: CheckCircle2,
      title: "Підтримку отримано",
      text: "Доступ активується вручну після перевірки платежу. Онови тариф, якщо статус ще не змінився.",
      className: "text-emerald-500",
    },
    failed: {
      icon: CircleX,
      title: "Підтримку не завершено",
      text: "Платіж було скасовано або не підтверджено. Можна повернутися до сторінки підтримки.",
      className: "text-red-500",
    },
    pending: {
      icon: Clock,
      title: "Статус підтримки уточнюється",
      text: "Ми перевіряємо платіж вручну. Зазвичай це потребує трохи часу після повідомлення на email.",
